...
$${\color{red}\text{This'll be printed in Carbon Fiber Nylon Filament so it is actually strong enough to be a drone chassis.}}$$
$${\color{cyan}This\space text\space is\space cyan}$$

Here is some $\color{red}\text{inline red text}$ within a sentence.
## Inspiration
...
|------|---------|----------|------------------|------|-------------|
| EVE 50PL 21700 5000mAh 50A Battery | This'll power the drone though its flight. I decided to buy Li-ion batteries and manually connect 4 to make a 4S cell to make a 5000mAh 4S battery pack. This'll help the drone fly longer. | 4 | 24.00 | https://www.18650batterystore.com/products/eve-50pl-21700-5000mah-50a-battery?variant=46405896798359 | 18650 Battery Store |
